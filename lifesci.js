const LIFESCI_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Life Sciences — Learner Book",
      href: "content/Life-sciences/grade10/Grade 10 Life Sciences_Learner Book.pdf",
      note: "Grade 10 Life Sciences_Learner Book.pdf"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 Life Sciences — Learner Book",
      href: "content/grade11//LifeSci-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Life Sciences textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 Life Sciences — Learner Book",
      href: "content/Life-sciences/grade12/SBA Life Science SBA Learner Guide.pdf",
      note: "SBA Life Science SBA Learner Guide.pdf"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, LIFESCI_CONTENT[g])));
