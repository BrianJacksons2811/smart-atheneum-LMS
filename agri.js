const AGRI_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Agricultural Science — Learner Book",
      href: "content/grade10/Agri-Grade10-Textbook.pdf",
      note: "Upload the Grade 10 Agricultural Science textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 Agricultural Science — Learner Book",
      href: "content/grade11/Agri-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Agricultural Science textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 Agricultural Science — Learner Book",
      href: "content/grade12/Agri-Grade12-Textbook.pdf",
      note: "Upload the Grade 12 Agricultural Science textbook to this path"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, AGRI_CONTENT[g])));
