const HIST_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 History — Learner Book",
      href: "content/grade10/Hist-Grade10-Textbook.pdf",
      note: "Upload the Grade 10 History textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 History — Learner Book",
      href: "content/grade11/Hist-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 History textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 SBA History LG ENG— Learner Book",
      href: "content/history/grade12/SBA History LG ENG.pdf",
      note: "SBA History LG ENG.pdf"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, HIST_CONTENT[g])));
