const ACC_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Accounting — Learner Book",
      href: "content/grade10/Acc-Grade10-Textbook.pdf",
      note: "Upload the Grade 10 Accounting textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 Accounting — Learner Book",
      href: "content/grade11/Acc-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Accounting textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 Accounting — Learner Book",
      href: "content/grade12/Acc-Grade12-Textbook.pdf",
      note: "Upload the Grade 12 Accounting textbook to this path"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, ACC_CONTENT[g])));
