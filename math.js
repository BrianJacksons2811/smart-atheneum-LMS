// ---------- Data: add links as you upload ----------
const MATH_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Mathematics — Learner Book (Siyavula / Everything Maths)",
      href: "content/grade10/Grade-10-Mathematics-Learner-Book.pdf",
      note: "CAPS-aligned textbook (PDF)"
    },
    quizzes: [
      // { title: "Algebraic Expressions — Quiz 1", href: "content/grade10/quizzes/algebra-quiz1.html" }
    ],
    videos: [
      // { title: "Functions: Intro (MP4)", href: "content/grade10/videos/functions-intro.mp4" }
    ]
  },
  "11": {
    textbook: { title: "Grade 11 Mathematics — Learner Book", href: "#", note: "Upload & link" },
    quizzes: [],
    videos: []
  },
  "12": {
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, MATH_CONTENT[g])));
  // open Grade 10 by default
