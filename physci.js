const PHYSCI_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Physical Sciences — Learner Book",
      href: "content/grade10/PhysSci-Grade10-Textbook.pdf",
      note: "Upload the Grade 10 Physical Sciences textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 Physical Sciences — Learner Book",
      href: "content/grade11/PhysSci-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Physical Sciences textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 MTG Physics — Learner Book",
      href: "content/grade12/Physical-sciences/MTG Physics Gr 12 Web.pdf",
      note: "MTG Physics Gr 12 Web.pdf"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, PHYSCI_CONTENT[g])));
