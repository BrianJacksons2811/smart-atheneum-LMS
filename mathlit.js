const MATHLIT_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 MathsLit_Learner Guide",
      href: "content/Maths-lit/grade 10/Grade 10 MathsLit_Learner Guide.pdf",
      note: "Grade 10 MathsLit_Learner Guide.pdf"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      ...
      href: "content/grade11/MathLit-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Math Lit textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 MTG Maths_Lit — Learner Book",
      href: "content/grade 12/Maths-lit/MTG Maths_Lit_Gr12_web.pdf",
      note: "MTG Maths_Lit_Gr12_web.pdf"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, MATHLIT_CONTENT[g])));
