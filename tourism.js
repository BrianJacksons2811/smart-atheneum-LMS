const TOUR_CONTENT = {
  "10": {
    textbook: {
      title: "Grade 10 Tourism — Learner Book",
      href: "content/grade10/Tourism-Grade10-Textbook.pdf",
      note: "Upload the Grade 10 Tourism textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "11": {
    textbook: {
      title: "Grade 11 Tourism — Learner Book",
      href: "content/grade11/Tourism-Grade11-Textbook.pdf",
      note: "Upload the Grade 11 Tourism textbook to this path"
    },
    quizzes: [],
    videos: []
  },
  "12": {
    textbook: {
      title: "Grade 12 Tourism — Learner Book",
      href: "content/grade12/Tourism-Grade12-Textbook.pdf",
      note: "Upload the Grade 12 Tourism textbook to this path"
    },
    quizzes: [],
    videos: []
  }
...
(function init(){
  ...
  ["10","11","12"].forEach(g => acc.append(buildGradePanel(g, TOUR_CONTENT[g])));
